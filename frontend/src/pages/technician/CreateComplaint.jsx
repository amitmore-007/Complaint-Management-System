...
import {
  useCreateTechnicianComplaint,
  useCreateTechnicianBulkComplaints,
...
const TechnicianCreateComplaint = () => {
  ...
  const createComplaintMutation = useCreateTechnicianComplaint();
  ...
  const createBulkMutation = useCreateTechnicianBulkComplaints();
