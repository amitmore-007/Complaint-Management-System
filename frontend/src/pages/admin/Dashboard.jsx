                                ...
                                <div key={index} className="relative group">
                                  <img
                                    ...
                                    onClick={() => {
                                      ...
                                      const resolutionPhotoIndex = (selectedComplaint.photos?.length || 0) + index;
                                      openPhotoModal(allPhotos, resolutionPhotoIndex);
                                    }}
                                  />
                                  <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-200 rounded-lg flex items-center justify-center">
                                    <div className="opacity-0 group-hover:opacity-100 transition-opacity flex space-x-2">
                                      ...
                                      <button
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          downloadPhoto(photo.url, photo.originalName || `resolution-photo-${index + 1}.jpg`);
                                        }}
                                        className="p-2 bg-white/20 backdrop-blur-sm rounded-full hover:bg-white/30 transition-all"
                                      >
                                        <Download className="h-4 w-4 text-white" />
