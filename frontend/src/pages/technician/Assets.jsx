...
const TechnicianAssets = () => {
  ...
  const fetchMyRecords = async () => {
    try {
      ...
      toast.error(
        error.response?.data?.message || "Failed to fetch your records"
      );
      setMyRecords([]);
    } finally {
      setIsLoading(false);
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          >
            Submit equipment records for stores
          </p>
        </div>
        ...
        {activeTab === "submit" ? (
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div>
                <label
                  className={`block text-sm font-medium mb-3 sm:mb-4 ${
                    isDarkMode ? "text-gray-300" : "text-gray-700"
                  }`}
                >
                  Equipment Inventory
                          ...
                          {itemData.isPresent && (
                            <div className="flex items-center justify-between sm:justify-end gap-3">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <span
                                  className={`w-8 sm:w-12 text-center font-medium text-sm sm:text-base ${
                                    isDarkMode ? "text-white" : "text-gray-900"
                                  }`}
                                >
                                  {itemData.count || 0}
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-4 mb-4">
                      <div className="min-w-0 flex-1">
                        ...
                        <div
                          className={`flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mt-2 text-xs sm:text-sm ${
                            isDarkMode ? "text-gray-400" : "text-gray-600"
                          }`}
                        >
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      >
                        <span className="font-medium">
                          {record.equipment?.filter((item) => item.isPresent)
                            .length || 0}
                        </span>{" "}
                        items present
                      </div>
