...
import {
  useCreateClientComplaint,
  useCreateClientBulkComplaints,
...
const CreateComplaint = () => {
  ...
  const createComplaintMutation = useCreateClientComplaint();
  ...
  const createBulkMutation = useCreateClientBulkComplaints();
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <AnimatePresence mode="wait">
              ...
              <form onSubmit={handleSubmit(onSingleSubmit)} className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 border rounded-xl transition-all duration-200 ${
                        isDarkMode
                          ? "bg-white/10 border-white/10 text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      {...register("priority")}
                      className={`w-full pl-4 pr-10 py-3 border rounded-xl appearance-none cursor-pointer transition-all duration-200 ${
                        isDarkMode
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                      {photos.map((photo) => (
                        <div key={photo.id} className="relative">
                          <img src={photo.preview} alt="Preview" className="w-full h-24 object-cover rounded-lg border border-gray-300 dark:border-gray-600" />
                          <button
                            type="button"
                ...
                <div className="flex space-x-4 pt-4">
                  <button
                    ...
                    className={`flex-1 py-2.5 px-4 border rounded-xl text-sm font-semibold transition-all duration-200 ${
                      isDarkMode
                  ...
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white py-2.5 px-4 rounded-xl text-sm font-semibold flex items-center justify-center space-x-2 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                  >
                    {isSubmitting ? (
          ...
          {mode === "bulk" && (
            ...
            >
              {bulkResults ? (
                <div className={`p-6 rounded-2xl shadow-lg border ${isDarkMode ? "bg-[#111] border-white/10" : "bg-white border-gray-200"}`}>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 bg-blue-600 text-white py-2.5 px-4 rounded-xl text-sm font-semibold hover:bg-blue-700 transition-all duration-200"
                    >
                      View Complaints
                    </button>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-blue-600 text-white py-2.5 px-4 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                    >
                      {isBulkSubmitting ? (
                        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white" />
                      ) : (
