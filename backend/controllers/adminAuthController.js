...
export const sendAdminOTP = async (req, res) => {
  try {
    ...
    console.log('📱 Admin OTP Request:', { phoneNumber });
    ...
    console.log('🔢 Generated Admin OTP:', otp, 'for', phoneNumber);
    ...
    console.log('💾 Admin OTP saved to database');
...
export const verifyAdminOTP = async (req, res) => {
  try {
    ...
    console.log('🔍 Admin OTP Verification:', { phoneNumber, otp, name });
    ...
    if (!admin) {
      ...
      await admin.save();
      console.log('👤 Created new admin:', { phoneNumber, name: defaultName });
    } else {
